...
export const seoConfig: Record<string, MetaTags> = {
  ...
  services: {
    title: "Servicios - NeoCharge | Desarrollo, Reparaciones y Más",
    description:
      "Desarrollo web, programación, reparaciones electrónicas, mantenimiento de splits y más servicios profesionales en La Habana.",
    keywords: "desarrollo web Cuba, reparación electrónica, mantenimiento splits, programación La Habana",
  },
  legal: {
