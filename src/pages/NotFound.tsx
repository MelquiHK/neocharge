...
import { Home, Search, Truck, Phone } from "lucide-react";
  ...
  return (
    <div className="container-page py-32 text-center space-y-6 max-w-lg">
      ...
      <div className="flex flex-wrap gap-3 justify-center">
        ...
        <Button asChild variant="outline"><Link to="/calcular-envio"><Truck className="w-4 h-4" /> Calcular envío</Link></Button>
        <Button asChild variant="outline"><Link to="/contacto"><Phone className="w-4 h-4" /> Contacto</Link></Button>
      </div>
    </div>
  );
};
