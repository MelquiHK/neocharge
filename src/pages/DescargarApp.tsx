...
/** Aparición suave al hacer scroll (autocontenida, sin dependencias). */
function Reveal({
  children,
  delay = 0,
  className = "",
...
const benefits = [
  ...
  },
  {
    ...
    text: "Explora los productos aunque la conexión esté lenta o se caiga.",
  },
  {
    icon: Bell,
  ...
  },
  {
    ...
    text: "Tus pedidos y garantía siempre disponibles en tu teléfono.",
  },
  {
    icon: Zap,
...
export default function DescargarApp() {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-blue-50/80 via-white to-white">
      {/* Orbes pastel */}
      <div
        className="absolute -top-24 -left-24 w-96 h-96 rounded-full bg-blue-200/40 blur-3xl pointer-events-none"
        aria-hidden
      />
      <div
        className="absolute top-1/3 -right-32 w-[28rem] h-[28rem] rounded-full bg-cyan-100/50 blur-3xl pointer-events-none"
        aria-hidden
      />
      ...
      <div className="relative container-page pt-10 md:pt-16 pb-20 md:pb-28">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="text-center lg:text-left">
            <Reveal>
              <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-100 text-blue-700 px-4 py-1.5 text-xs font-bold uppercase tracking-widest">
            ...
            <Reveal delay={2}>
              <p className="mt-5 text-lg text-slate-600 max-w-xl mx-auto lg:mx-0">
                ...
                y pedidos, más rápido y cómodo que en el navegador.
              </p>
            </Reveal>
            ...
            <Reveal delay={3}>
              <div className="mt-8 flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                ...
                <Link
                  to="/tienda"
                  className="inline-flex items-center gap-2 px-6 py-4 rounded-full border border-blue-200 text-blue-700 font-bold hover:bg-blue-50 transition-colors"
                >
          ...
          <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {benefits.map((b, i) => (
              <Reveal key={b.title} delay={(i % 3) + 1}>
                <div className="rounded-3xl p-6 h-full bg-white/80 backdrop-blur border border-blue-100 shadow-xl shadow-blue-100/50 hover:-translate-y-1 hover:shadow-2xl transition-all">
        ...
        <Reveal className="mt-16 md:mt-20">
          <div className="rounded-[2rem] p-8 md:p-12 text-center relative overflow-hidden bg-white/80 backdrop-blur border border-blue-100 shadow-xl shadow-blue-100/50">
            <div
              className="absolute -top-20 left-1/2 -translate-x-1/2 w-72 h-72 rounded-full bg-blue-200/40 blur-3xl pointer-events-none"
              aria-hidden
            />
