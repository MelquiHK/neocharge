...
const CalcularEnvio = () => {
  ...
  return (
    <div className="cr-page w-full max-w-full overflow-x-clip">
      ...
      <div className="container-page relative py-12 sm:py-16 lg:py-24">
        <header className="text-center space-y-4 mb-8 sm:mb-10">
          ...
          <Reveal delay={1}>
            <h1 className="font-display text-4xl md:text-5xl font-bold tracking-tight">
              Calcula tu <span className="cr-shimmer-text">envío</span>
            </h1>
          </Reveal>
          <Reveal delay={2}>
        ...
        <Reveal delay={3}>
          <section className="cr-glass cr-sheen cr-lift mt-12 rounded-3xl p-8 md:p-10 text-center space-y-4">
